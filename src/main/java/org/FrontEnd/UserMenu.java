 ...
 public class UserMenu {
    ...
    public void UserInput() {
        ...
        switch (choice) {
            ...
            case 3:
                ...
                break;
            case 4:
                searchTransactionsByDate();// поиск по дате
                break;
            case 5:
                createAccount();
                break;
    ...
    private void processTransaction(TransactionType transactionType) {
        ...
        if (transactionType == TransactionType.TRANSFER) {
            ...
            Integer transferAccountId = scanner.nextLong();
            scanner.nextLine();

            TransactionBalanceAcountService.transfer(accountId, transferAccountId, amount);
        } else {
